...
const Nevbar = () => {
  return (
    <nav className="w-full flex justify-center items-center h-[5rem] shadow-lg">
      <ul className="w-[50%] flex flex-row justify-evenly items-center text-[1.1rem] tracking-[0.1rem]">
        ...
        <li>|</li>
        <li><a href="#contact" className="nev-el pb-[3px] px-[5px] hover:border-b-2 border-b-2 border-b-transparent transition-all hover:border-b-[#b2d1c9]"> CONTACT</a></li>
        <li>|</li>
